...
Original file is located at
    https://colab.research.google.com/drive/16mOhdrpq8eCP0u03Q9316GJfuaU4SciW
"""
...
bot = telebot.TeleBot(os.getenv("TELE_CLIENT"))
logger = telebot.logger
telebot.logger.setLevel(logging.DEBUG)
session_file = 'Jyothika_C.session'
api_id = os.getenv("API_ID")
api_hash = os.getenv("API_HASH")
whitelist = ['Jyothika_C', 'samueltqh30', 'apollotan','jeonwonje','raihahan']
...
def start_client(message):
    ...
    for message in client.iter_messages('jeonwonje',reverse=True):
        print(message.sender_id, ':', message.text)

    chat_txt = ""

    for message in client.iter_messages('jeonwonje',reverse=True):
        if message.sender_id is not None and message.text is not None:
